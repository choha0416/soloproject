...
<body>
	...
	<div class="container py-4">
		...
		<div class=align-items-md-stretch text-center>
		<%
		...
		<div class="col-md-4">
			<div class="h-100 p-2 round-3">
				<img src="./resources/images/<%=rs.getString("a_filename") %>" style="width:250; height:350" /><!-- 이미지 -->
				<p><h5><b><%=rs.getString("a_name") %></b></h5></p>
				...
				<p><%
					...
					%>
				<a href="./updateAlbum.jsp?id=<%=rs.getString("a_id")%>" class="btn btn-secondary" role="button">수정<i class="bi bi-box-arrow-in-right"></i></a>	
				<%
						}
				%>
			</div>
