...
public class AlbumRepository {
	...
	public AlbumRepository() {
		Album album1 = new Album("IASNHZ1106","FALLIN'",20000);
		...
		album1.setUnitsInStock(2000);
		album1.setReleaseDate("2024/11/06");
		album1.setFilename("ISANHZ1106.jpg");
		
		Album album2 = new Album("ISANBD1113","Blue Ocean",15000);
		...
		album2.setUnitsInStock(2000);
		album2.setReleaseDate("2018/11/13");
		album2.setFilename("ISANBD1113.jpg");
		
		Album album3 = new Album("ISANRT1105","너의 계절이 돌아올거야",13000);
		...
		album3.setUnitsInStock(2000);
		album3.setReleaseDate("2023/11/05");
		album3.setFilename("ISANRT1105.jpg");
