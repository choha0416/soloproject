...
<%
	...
	String sql = "INSERT INTO album (a_id, a_name, a_unitPrice, a_singer, a_desciption, a_publisher, a_category, a_unitsInStock, a_releaseDate, a_condition, a_fileName) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
