	...
	<div class="container py-4">
		...
		<div class="p-5 mb-4 bg-body-tertiary rounded-3">
			<div class="container-fluid py-5">
				<h1 class="display-5 fw-bold">앨범 정보</h1>
		...
		<div class = "row align-items-md-stretch">
			<div class="col-md-12">
				...
				<p><b>앨범코드 : </b><span class="badge text-bg-danger"><%=album.getAlbumId() %></span></p>
				...
				<div class="d-flex justify-content-start align-items-center">
    				<p><a href="#" class="btn btn-info me-2 d-flex align-items-center">
        		 	<i class="bi bi-cart-plus"></i> 앨범 주문<!-- 앨범 주문과 오른쪽 화살표 간의 간격 -->
    				</a></p>
    				<p><a href="./albums.jsp" class="btn btn-secondary"> <i class="bi bi-box-arrow-in-left"></i>앨범 목록</a></p>
				</div>
